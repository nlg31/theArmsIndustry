def magic4(x):
	...
	if(int(n[0])==0):
		...
		if int(n)<20:
			...
			elif int(n[1:3])<20 and int(n[1:3])>00:
				print(n,'is',m1[int(n[0])]+m3[len(n)]+m1[int(n[1:3])],'and')
				n=m1[int(n[0])]+m3[len(n)]+m1[int(n[1:3])]
			elif int(n[2])==0:
			...
			if int(n[1:4])==000:
			...
			elif int(n[2:4])==00 and int(n[1])!=0:
				...
				print(n,'is',m1[int(n[0:1])]+m3[len(n)]+m2[int(n[2:3])]+m1[int(n[3])],'and')
				n=m1[int(n[0:1])]+m3[len(n)]+m2[int(n[2:3])]+m1[int(n[3:4])]
			magic4(n)
		
		elif len(n)==5:
			if int(n[1:5])==0000 and int(n[0:2])<20:
				print(n, 'is', m1[int(n[0:2])]+m3[len(n)])
				n=m1[int(n[0:2])]+m3[len(n)]
			elif int(n[0:2])>20:
				print(n, 'is', m2[int(n[0])]+m1[int(n[1])]+m3[len(n)]+m1[int(n[2])])
				n=m2[int(n[0])]+m1[int(n[1])]+m3[len(n)]+m1[int(n[2])]
			magic4(n)
	
		elif len(n)>5:
			print('try a smaller number, no more than 5 digits')
